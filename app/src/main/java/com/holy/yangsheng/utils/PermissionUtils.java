 ...
 *
 * 可选申请的权限:
 * android.permission.ACCESS_FINE_LOCATION</li>
 *
 * Android 6.0 权限申请工具</p>
 * Created by Holy on 16-1-21.
 */
public class PermissionUtils {
	...
	/**
	 * tips:这里的int数值不能太大，否则不会弹出请求权限提示，测试的时候,改到1000就不会弹出请求了
	 */
